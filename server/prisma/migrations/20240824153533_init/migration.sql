...
CREATE TABLE "ExpeseByCategory" (
    ...
    CONSTRAINT "ExpeseByCategory_pkey" PRIMARY KEY ("expenseByCategoryId")
);
...
-- AddForeignKey
ALTER TABLE "ExpeseByCategory" ADD CONSTRAINT "ExpeseByCategory_expenseSummaryId_fkey" FOREIGN KEY ("expenseSummaryId") REFERENCES "ExpenseSummary"("expenseSummaryId") ON DELETE RESTRICT ON UPDATE CASCADE;
